...
type JobSummary struct {
	...
	// two above.
	Tries int
	// Browser, OS and Release name the identity this job's ports wore, and
	// nothing named is a job spread over every browser and system this program
	// knows — see JobSpec.Browser.
	Browser string
	OS      string
	Release int
