...
func TestLiveAPI_ASearchAnsweredInOneConnection(t *testing.T) {
	...
	sup := web.NewSupervisor(st, func(ctx context.Context, want web.Wanted) (web.Identities, error) {
		return web.Identities{Search: livePool(ctx, t, want.Ports, want.Threads)}, nil
