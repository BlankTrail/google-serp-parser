...
var catalogue = map[Lang]map[string]string{
	LangEN: {
		...
		"proxies.vdns":               "vDNS mode",
		"proxies.vdns.auto":          "Automatic",
		"proxies.vdns.on_leak":       "Only when the name would leak",
		"proxies.vdns.forced":        "Always through the exit",
		"proxies.vdns.on":            "Resolve names through the exit",
	...
	LangRU: {
		...
		"proxies.vdns":               "Режим vDNS",
		"proxies.vdns.auto":          "Авто",
		"proxies.vdns.on_leak":       "Только при утечке имени",
		"proxies.vdns.forced":        "Всегда через выход",
		"proxies.vdns.on":            "Разрешать имена через выход",
