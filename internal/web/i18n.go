...
var catalogue = map[Lang]map[string]string{
	LangEN: {
		...
		"help.what":                    "What these do",
		"job.reshape.group":            "What can still be changed",
		"proxies.source":               "Where the addresses come from",
		"proxies.spending":             "How the addresses are spent",
		"proxies.madeof":               "What the ports are made of",
	...
	LangRU: {
		...
		"help.what":                    "Что это меняет",
		"job.reshape.group":            "Что ещё можно изменить",
		"proxies.source":               "Источник адресов",
		"proxies.spending":             "Как расходуются адреса",
		"proxies.madeof":               "Из чего сделаны порты",
