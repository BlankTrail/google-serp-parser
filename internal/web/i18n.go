...
var catalogue = map[Lang]map[string]string{
	LangEN: {
		...
		"job.export.builder":     "Choose fields and format…",
		"field.title":            "Title",
		"field.url":              "Address",
		...
		"job.pool":              "Identities of this job",
		...
		"job.standing":          "Where the threads are",
		...
		"proxies.reading.none":         "Nothing has gone out since this program started.",
	...
	LangRU: {
		...
		"job.export.builder":     "Настроить выгрузку…",
		...
		"job.pool":              "Личности этого задания",
		"job.sessions":          "Сессий",
		...
		"job.standing":          "Где сейчас потоки",
		...
		"proxies.reading.none":         "С запуска программы запросов не было.",
