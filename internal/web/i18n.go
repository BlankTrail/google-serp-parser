...
var catalogue = map[Lang]map[string]string{
	LangEN: {
		...
		"job.speed":            "Queries/min",
		"job.speed.pages":      "Pages/min",
		...
		"state.speed":           "Queries a minute",
		"state.speed.pages":     "Pages a minute",
	...
	LangRU: {
		...
		"state.speed":           "Запросов в минуту",
		"state.speed.pages":     "Страниц в минуту",
