...
//
// To add version 6: write the file, embed it, append it here. Nothing else —
...
var steps = []string{schemaStep1, schemaStep2, schemaStep3, schemaStep4, schemaStep5, schemaStep6, schemaStep7, schemaStep8}
