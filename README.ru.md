...
На машине, где ещё ничего не запускали, программа открывается на **быстром
старте**: связь, выходы и первое задание, у каждого шага названы поля, которые
важны, и есть переход на экран, где он делается. Состояние каждого шага
считывается с машины, так что уже настроенное отмечено сразу. Гид можно
пропустить, и он остаётся в шапке.

![Быстрый старт: связь, выходы и первое задание — для чего каждый шаг и какие поля важны](assets/screenshots/guide-ru.png)
...
- **Светлый интерфейс, тёмный — по желанию.** Интерфейс светлый, а тёмный —
  нажатие в шапке, которое запоминается. Раньше он шёл за тем, что скажет
...
- **Быстрый старт** на машине, где ещё ничего не запускали: названы важные поля
  и есть переход на экран, где каждый шаг делается.
...
- **Быстрый старт** для машины, где ещё ничего не запускали: связь, выходы и
  первое задание, состояние каждого шага считывается с машины, так что уже
  сделанное отмечено сразу.
...
- **Светлый по умолчанию, тёмный по желанию** — нажатие в шапке, запоминается
  для этого браузера.
