...
| Менять личность раз в, минут | Как часто порт открывается заново — со свежим отпечатком и пустыми куками. Ноль — никогда; при выборе шлюзов предлагается десять |
