...
- Страница идущего задания читает личности под ним: адресов в списке и в бане,
  портов открыто, прогрето и в карантине, сессий и сколько из них на паузе — и
  проверки Google: сколько задание прошло, сколько решается, сколько ждёт
  решателя и сколько запросов приходится на одну проверку. Последнее считается
  по сессиям, которые Google уже впустил: свежая сессия платит проверкой за сам
  вход, с какой бы скоростью её ни спрашивали. Через десять минут после старта
  проверки чаще одной на семь таких запросов означают, что сессии спрашивают
  снова раньше, чем они отдохнули, — страница об этом говорит.
