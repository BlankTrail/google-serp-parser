...
Откройте **«Прокси»**. На этом одном экране — все настройки, касающиеся
личностей, и живое состояние пула во время работы.

**«Читать»** выбирает источник, и их три:
...
Там же задаётся, как ведёт себя пул:
