...
- Страница идущего задания читает личности под ним: адресов в списке и в бане,
  ...
  решателя и сколько запросов приходится на одну проверку. Проверки чаще одной
  на семь запросов означают, что сессии спрашивают снова раньше, чем они
  отдохнули, — страница об этом говорит.
